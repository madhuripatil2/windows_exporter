...
-----|-------------|------|-------
`windows_cs_logical_processors` | Number of installed logical processors | gauge | yes
`windows_cs_physical_memory_bytes` | Total installed physical memory | gauge | yes
